    ...
    return(
        <div className="col">
            <div className="step-form-container">
                ...
                <p className="step-desc">You have the option of monthly or yearly billing.</p>
                <form className="form-plan-container">

                    <div className="plans-container">

                        <div 
                        className={`plan-single ${plan==='arcade'?'selected':''}`}
                        ...
                        >
                            ...
                            <div className="plan-info">
                                ...
                                <p
                                style={!yearly?{display:'none'}:null}  
                                className="plan-year-text"
                                >2 months free</p>
                            </div>
                        </div>

                        <div 
                        className={`plan-single ${plan==='advanced'?'selected':''}`}
                        ...
                        <div 
                        className={`plan-single ${plan==='pro'?'selected':''}`}
                        onClick={()=>setPlan('pro')}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"><g fill="none" fillRule="evenodd"><circle cx="20" cy="20" r="20" fill="#483EFF"/><path fill="#FFF" fillRule="nonzero" d="M26.666 13H13.334A3.333 3.333 0 0 0 10 16.333v7.193a3.447 3.447 0 0 0 2.14 3.24c1.238.5 2.656.182 3.56-.8L18.52 23h2.96l2.82 2.966a3.2 3.2 0 0 0 3.56.8 3.447 3.447 0 0 0 2.14-3.24v-7.193A3.333 3.333 0 0 0 26.666 13Zm-9.333 6H16v1.333a.667.667 0 0 1-1.333 0V19h-1.333a.667.667 0 0 1 0-1.334h1.333v-1.333a.667.667 0 1 1 1.333 0v1.333h1.333a.667.667 0 1 1 0 1.334Zm7.333 2a2.667 2.667 0 1 1 0-5.333 2.667 2.667 0 0 1 0 5.333ZM26 18.333a1.333 1.333 0 1 1-2.667 0 1.333 1.333 0 0 1 2.667 0Z"/></g></svg>                            <div className="plan-info">
                                <div className="plan-info">
                        ...
                        <div className="plan-option-container">
                            ...
                            <label className="plan-switch">
                                <input
                                 checked={!yearly} 
                                 onClick={()=>setYearly(prevYearly=>!prevYearly)}
                                 onChange={()=>{}}
                                 type="checkbox" />
